...
# ---------------------------------------------------------------------------------------------------------------------
variable "name" {
  description = "The name of the asg to create."
  type        = string
}
...
variable "cloudwatch_alarm_cpu_high" {
  type        = string
  default     = "asg-cloudwatch-alarm-cpu-high"
  description = "The name of the cloudwatch alarm CPU high."
}

variable "cloudwatch_alarm_cpu_low" {
  type        = string
  default     = "asg-cloudwatch-alarm-cpu-low"
  description = "The name of the cloudwatch alarm CPU low."
}